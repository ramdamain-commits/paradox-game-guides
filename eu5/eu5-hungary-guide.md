...
| 時期 | 重装歩兵（Heavy Inf） | 軽装騎兵（Light Cav） | 重装騎兵（Heavy Cav） | 砲兵 | 備考 |
|------|---------------------|---------------------|---------------------|------|------|
| 序盤（Age 1-2） | 30-40% | 40-50% | 0-10% | 10-20% | 複合弓軽騎兵ボーナスを最大活用 |
| 中盤（Age 3-4） | 30-40%（黒軍主体） | 20-30% | 20-30%（フサール主体） | 10-20% | 黒軍で要塞守備、フサールで機動戦 |
| 後半（Age 5-6） | 25-35%（黒軍） | 20-25%（ハイドゥク含む） | 20-30%（フサール） | 15-25% | ハイドゥクは山岳・丘陵戦のみ投入 |
...
| フサール（Heavy Cav） | ◎ | △（コスト減） | △（コスト減） | × | 進軍コスト減で山岳機動に対応 |
...
騎兵偏重になりがちだが、歩兵・砲兵をそれぞれ 10% 以上保てば Combined Arms ボーナスが発動する。黒軍（Heavy Inf）・フサール（Heavy Cav）・砲兵を 10% 以上ずつ混ぜた編成でボーナスを確保する（コミュニティ知見）。
...
| イベント名 | ID | 発生期間 | 推奨選択 + 理由 |
|-----------|-----|---------|----------------|
| [年]年のヴィシェグラード会議 | `flavor_hun.330` | 1337-1370（月 75%、POL カジミェシュ 3 世 + HUN カーロイ・ロベルト） | 「あの合意を成文化しよう」→ POL に hun.331 送信、PU pact 契機（コミュニティ知見） |
| [国名]の金 | `flavor_hun.340` | 1340-1390（月 100%、カーロイ・ロベルト没後 + gold_export_ban 有効） | 「禁令を延長しろ」→ Gold +2 scale（コミュニティ知見：長期的な内需優先） |
| 1222年の金印勅書 | `flavor_hun.350` | 1340-1440（月 1%、君主 adm/dip/mil 全て < 50 + 未付与） | 状況次第（コミュニティ知見）。「復活させよう」で貴族特権 `golden_bull_of_1222` 付与・貴族満足度 mild_bonus vs 「拒否」で安定度・統治力ペナルティ |
| 聖ゲオルギウス騎士団 | `flavor_hun.370` | 1337-1437 | 「騎士団を拡大させるのだ！」→ 軍事ボーナス（コミュニティ知見：効果詳細未確認） |
| ペーチの大学 | `flavor_hun.400` | 1350-1400 | 「これはわが国の利益となるだろう……」→ 文化・教育ボーナス（コミュニティ知見：効果詳細未確認） |
| ボスニア問題 | `flavor_hun.600` | 1340-1500 | 外交優先（コミュニティ知見） |
| 彩飾年代記 | `flavor_hun.460` | 1358-1375 | 文化イベント。受諾推奨（コミュニティ知見） |
| ヴラフ法 | `flavor_hun.360` | 1337-1600 | 文化・民族管理。状況次第（コミュニティ知見） |
### 中盤（1400〜1550）

| イベント名 | ID | 発生期間 | 推奨選択 + 理由 |
|-----------|-----|---------|----------------|
| ヤーノシュ・フニャディ登用 | `flavor_hun.1` | 1430-1443（月 5%、fire_only_once） | 「採用」→ Gold -1 scale、adm 84-94/dip 70-80/mil 90-100 の最高水準将軍候補 `[src: events/DHE/flavor_HUN.txt + script verified]` |
| [年]年の議会 | `flavor_hun.2` | 1444-1470（月 50%、議会 + 摂政 + 戦争 + フニャディ存命） | 「フニャディを摂政に」→ 軍事力強化（コミュニティ知見） |
| マティアス・コルヴィヌスの改革 | `flavor_hun.110` | 1466-1470（月 10%、ハンガリアディ家君主） | 「行政改革」→ 中央集権化（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt]` |
| アカデミア・イストロポリターナ | `flavor_hun.120` | 1465-1470 | 「これはわが国の利益となるだろう……」→ 威信＋大学建設（コミュニティ知見） |
| ブダの印刷所 | `flavor_hun.130` | 1473-1500 | 「素晴らしい！」→ 芸術作品「クロニカ・ハンガロルム」生成（品質 85）（コミュニティ知見） |
| [王名]の軍隊 | `flavor_hun.200` | 1455-1470（月 5%、摂政なし） | 唯一選択肢 → 質・陸・攻勢寄りに Societal Value 移動（黒軍前身）`[src: events/DHE/flavor_HUN.txt]` |
| ハンガリーの要（ベオグラード） | `flavor_hun.210` | 1450-1500（ベオグラード + TUR 隣接 + 要塞有り） | 「国費をさらに投入しよう」→ vegvar_system 解禁（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt]` |
| セルビア陥落 | `flavor_hun.220` | 1337-1600（SER 消滅後） | 唯一選択肢 → TUR セルビア文化都市からの移民（amount 0.2、20 年）`[src: events/DHE/flavor_HUN.txt]` |
| ボヘミア・カトリックからの支援要請 | `flavor_hun.180` | 連鎖発火 | 「デウス・ウルト」→ BOH 支援要請 + ズノイモ等に征服 CB（コミュニティ知見） |
| ドラゴン騎士団 | `flavor_hun.410` | 1400-1450（月 5%、騎士団法律 + バルカンにオスマン文化イスラム 5 都市以上） | 「いまこそドラゴン騎士団を結成するのだ」→ Gold -6、対オスマン同盟強化（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt]` |
| ビブリオテカ・コルヴィニアーナ | `flavor_hun.510` | 1450-1490（月 2%、fire_only_once） | 「素晴らしい！」→ 首都に bibliotheca_corviniana 建物（コミュニティ知見） |
| ブラン城 | `flavor_hun.520` | 1377-1420（月 2%、ブラショフ所有 + castle 未建設） | 「素晴らしい案だ！」→ ブラショフに castle 建設（50% off）（コミュニティ知見） |
| 新首都ウィーン | `flavor_hun.550` | 1470-1490（月 2%、ウィーン占領・HRE 存在） | オーストリア逆転ルートなら「素晴らしい案だ！」（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt + script verified]` |
| 三部法書 | `flavor_hun.560` | 1517-1530 | 法律イベント（コミュニティ知見） |
| ブダ城拡張 | `flavor_hun.450` | 1430-1460 | 建設イベント（コミュニティ知見） |
| スラブ人特権令 | `flavor_hun.470` | 1381-1391 | 民族管理（コミュニティ知見） |
| バラージュ・マジャル | `flavor_hun.490` | 1435-1450 | 黒軍前提・人物イベント（コミュニティ知見） |
| パール・キニジ | `flavor_hun.500` | 1460-1470 | 黒軍前提・人物イベント（コミュニティ知見） |
| ユサールの起源 | `flavor_hun.590` | 1400-1500（`hun_composite_light_cavalry` 取得後） | 軍事・フレーバー（コミュニティ知見） |
| バコーツ・タマーシュ | `flavor_hun.170` | 1490-1520 | 外交イベント（コミュニティ知見） |
| 北ハンガリー地方に盗賊横行 | `flavor_hun.190` | 1430-1440 代（中盤） | 「盗賊どもを叩き潰せ！」→ 治安回復（コミュニティ知見） |

### 中盤〜終盤（1500〜）

| イベント名 | ID | 発生期間 | 推奨選択 + 理由 |
|-----------|-----|---------|----------------|
| [デブレツェン]の教会会議 | `flavor_hun.230` | 1560-1570（カトリック + カルヴァン派人口 > 0） | 宗教方針次第（[宗教改革への対応](#宗教改革への対応1500-年前後)を参照）`[src: events/DHE/flavor_HUN.txt]` |
| エルデーディ・タマーシュ | `flavor_hun.270` | 1583-1610（月 10%、ザグレブ所有、fire_only_once） | 唯一選択肢 → adm 80/dip 80/mil 83 のキャラクター採用 `[src: events/DHE/flavor_HUN.txt + script verified]` |
| トマーシュ・ナーダシュディ | `flavor_hun.240` | 1530-1555 | 人物イベント（コミュニティ知見） |
| ハンガリーの農民反乱 | `flavor_hun.160` | 1450-1650（`hun_power_to_magnates` 保持 + 安定度 < -20。中盤〜終盤にまたがって発火） | 安定度を整えておく。「反乱分子のクズどもめ！」で鎮圧（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt]` |
| トランシルヴァニア改革 | `flavor_hun.540` | 1530-1550 | 宗教イベント（コミュニティ知見） |
| [国名]の吸血鬼 | `flavor_hun.140` | 1600-1650（月 5%、fire_only_once） | 「止めろ」→ 貴族満足度 mild_penalty・対象処刑。農民ペナルティより管理しやすい `[src: events/DHE/flavor_HUN.txt + script verified]` |
| [国名]の進出 | `flavor_hun.150` | 1550-1650（HAB が HRE 皇帝 + HUN 都市数 < 5 + TUR 休戦 + TUR がカルパティア旧 HUN 領保有） | **発生させないのが最善**（オスマンに敗北しない、都市 5 以上維持）`[src: events/DHE/flavor_HUN.txt + script verified]` |
| [王名]の絶対的統治 | `flavor_hun.320` | 後半 | 「国家は[王名]の支配下にある」→ 中央集権化の推進（コミュニティ知見） |
| 首都避難計画 | `flavor_hun.580` | 1526-1600（ブダ首都 + ブダ隣接オスマン + ブラチスラバ保有） | オスマン圧迫中なら「ブラチスラバへ」（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt + script verified]` |
| 歪んだ聖冠 | `flavor_hun.430` | 1600 年以降（月不定期、君主制 + 聖冠所有） | 選択肢 A（Gold -5・正統性 weak_penalty）推奨。選択肢 C/D は聖冠損傷で追加ペナルティ `[src: events/DHE/flavor_HUN.txt + script verified]` |
| 壊れた伝統 | `flavor_hun.440` | 聖冠喪失後（常時 trigger） | 唯一選択肢: 聖冠所在地への征服 CB 付与・貴族満足度 extreme_penalty・正統性 ultimate_penalty `[src: events/DHE/flavor_HUN.txt + script verified]` |
| 北ハンガリー地方の都市同盟 | `flavor_hun.300` | 中盤 | 「彼らの特権を守ってやろう」→ 鉱山都市の経済安定（コミュニティ知見） |
| オーストリア貴族の反乱 | `flavor_hun.480` | 1700-1836（HAB 消滅後、オーストリア領保有） | 「中央集権路線」推奨（コミュニティ知見）`[src: events/DHE/flavor_HUN.txt + script verified]` |
| スロヴァキア民族覚醒 | `flavor_hun.530` | 1750-1810 | 民族管理（コミュニティ知見） |
| アダム・フランティシェク・コッラール | `flavor_hun.570` | 1760-1780 | 人物イベント（コミュニティ知見） |
...
| `flavor_hun.331/.332` | ヴィシェグラード第 2・3 回 | hun.330 の連鎖 |
| `flavor_hun.18` | ヴィシェグラード拒否 | POL が会議を拒否した場合 |
| `flavor_hun.411` | ドラゴン騎士団参加要請 | hun.410 の連鎖。周辺国への参加打診 |
| `flavor_hun.421/.422` | 馬上槍試合 | 中盤フレーバー連鎖 |
| `flavor_hun_ser.1000` | ベオグラードの提案（SER 視点） | SER 連動 |
| `flavor_hun_ser.1001` | ベオグラードの提案（HUN 視点） | SER 連動 |
| `flavor_hun_ser.1002` | ポジティブ応答 | SER 連動 |
| `flavor_hun_ser.1003` | ネガティブ応答 | SER 連動 |
