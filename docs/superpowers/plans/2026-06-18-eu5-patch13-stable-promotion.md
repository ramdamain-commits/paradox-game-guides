...
| 船コスト増・海戦致死性 | 「後半の海軍戦略」＋「Greek Fire Ships」 | エーゲ海/ボスポラス制海コストとして海軍章に統合 |
| Twilight of the Tsardom | 「バルカン再征服の段階的進行」（中盤） | regional 側の昇格後位置と相互リンク張り直し |

### ottoman（オスマン帝国）
| 1.3 差分項目 | 統合先の既存章 | 注記・要確認 |
|------|------|------|
| 船コスト4x/10x・海戦致死性 | 「中盤・欧州方面」（地中海制海）＋「内政・経済」 | ottoman は独立した海軍章がない→中盤欧州＋内政経済に分散統合 |
| 建物維持費逓増+50% | 「内政・経済」 | 広域版図の長期維持費。section 363 系へ |
| 陸軍 goods 2 倍 | 「内政・経済」＋「軍事ドクトリン・イェニチェリ運用」 | 大量常備軍のランニングコスト |
...
| Union of Crowns 女性継承 | 「中盤・ポーランド同君連合」/「ヴィシェグラード会議」 | PU 成立条件の文脈 |
| **no_female_heirs_for_poland 例外** | 「中盤・ポーランド同君連合」 | **必須残置（A-7）**。対ポーランド PU を女性後継で繋げない点を本文明記 |

### austria（オーストリア／ハプスブルク）
| 1.3 差分項目 | 統合先の既存章 | 注記・要確認 |
|------|------|------|
| 従属国への宗教統一強制不可 | 「中盤・宗教改革への備え」＋「内政・階級管理」 | 異宗派従属国の管理方針を強制→外交/自発改宗へ書き換え |
